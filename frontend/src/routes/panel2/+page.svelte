<script lang="ts">
    ...
    import KhoiDong from "./components/KhoiDong.svelte";
    import Vcnv from "./components/VCNV.svelte";
    import TangToc from "./components/TangToc.svelte";
    import VeDich from "./components/VeDich.svelte";
    import PartSwitcher from "./components/PartSwitcher.svelte";
    import TieBreaker from "./components/TieBreaker.svelte";
    import Tkd from "./components/TKD.svelte";
